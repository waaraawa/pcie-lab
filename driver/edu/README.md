...
The DMA test fills that buffer with a deterministic 64-byte pattern, copies it
from RAM to EDU offset `0x40000`, clears the RAM buffer, and copies it back from
